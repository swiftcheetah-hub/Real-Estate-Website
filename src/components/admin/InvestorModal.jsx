...
import { X, Upload, TrendingUp, Save, Edit2, Image as ImageIcon, Trash2 } from 'lucide-react'

const InvestorModal = ({ isOpen, onClose, investor = null, onSave }) => {
    ...
    if (isOpen) {
      if (investor) {
        setFormData({
          ...
          displayOrder: investor.displayOrder || 0,
          isActive: investor.isActive !== undefined ? investor.isActive : true,
        })
        setPreviewImage(investor.imageUrl || '')
        setImageFile(null)
      } else {
        setFormData({
          name: '',
          ...
          <div className="flex items-center gap-3">
            {isEditMode ? (
              <>
                ...
                <h2 className="text-2xl font-bold text-white">Edit Investor</h2>
              </>
            ) : (
              <>
                <TrendingUp className="w-6 h-6 text-primary" />
                <h2 className="text-2xl font-bold text-white">Add New Investor</h2>
              </>
            )}
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="This guide helped me identify profitable investment opportunities..."
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-4 border-t border-primary/20">
            ...
            >
              ...
              {isEditMode ? 'Save Changes' : 'Add Investor'}
            </button>
          </div>
        </form>
      </div>
